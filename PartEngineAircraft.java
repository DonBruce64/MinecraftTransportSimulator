...
public class PartEngineAircraft extends APartEngine{
	...
	public void updatePart(){
		...
		if(state.running){
			...
			if(propeller != null){
				double propellerForcePenalty = (propeller.definition.propeller.diameter - 75)/(50*(this.definition.engine.fuelConsumption+(this.definition.engine.superchargerFuelConsumption*(this.definition.engine.superchargerEfficiency*2))) - 15);
