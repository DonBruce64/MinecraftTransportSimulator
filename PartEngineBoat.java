...
public class PartEngineBoat extends APartEngineGeared{
	...
	public double getForceOutput(){
		return state.running && isInLiquid ? RPM/definition.engine.maxRPM*50*(definition.engine.fuelConsumption + (definition.engine.superchargerFuelConsumption*(definition.engine.superchargerEfficiency*2)))*currentGear : 0;
	}
