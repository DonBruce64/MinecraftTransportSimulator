...
public class BuilderEntityLinkedSeat extends ABuilderEntityBase {
    public static RegistryObject<EntityType<BuilderEntityLinkedSeat>> ENTITY_SEAT;
    ...
    public BuilderEntityLinkedSeat(EntityType<? extends BuilderEntityLinkedSeat> eType, World world) {
        super(BuilderEntityLinkedSeat.ENTITY_SEAT.get(), world);
    }
        ...
        if (entity != null) {
            ...
            if (!entity.isValid) {
                ...
                if (rider == null && !riders.isEmpty()) {
                    ...
                    if (!world.isClient || ++ticksWithoutRider == 10) {
                        remove();
                    }
    ...
    public void remove() {
        ...
        if (entity != null && rider != null) {
            if (!world.isClient && rider.equals(entity.rider)) {
                entity.removeRider();
            }
            rider = null;
            entity = null;
    ...
    public NbtCompound writeNbt(NbtCompound nbt) {
        ...
        if (entity != null) {
            ...
            nbt.putUuid("entityUUID", entity.uniqueUUID);
        }
        return nbt;
    }
}
