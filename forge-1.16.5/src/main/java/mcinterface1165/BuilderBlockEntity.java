 ...
 * @author don_bruce
 */
public class BuilderBlockEntity extends BlockEntity implements Tickable {
    ...
    protected static RegistryObject<BlockEntityType<BuilderBlockEntity>> TE_BASE;
    ...
    public BuilderBlockEntity(BlockEntityType<?> teType) {
        super(teType);
    ...
    public void tick() {
        ...
        if (world != null && pos != null) {
            if (tileEntity != null) {
                ...
                if (lastLoadedNBT != null && !world.isClient) {
                ...
                if (loadFromSavedNBT && world.canSetBlock(pos)) {
                    try {
