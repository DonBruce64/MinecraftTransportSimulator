...
public class JSONVehicle extends AJSONPartProvider {
    ...
    public static class VehicleMotorized {
        ...
        @JSONDescription("An optional x/y/z offset, relative to the vehicle origin and orientation, to use as the third-person camera pivot.  If omitted, MTS will use its default third-person camera position for the vehicle type.")
        ...
        @JSONDescription("If this is true, the vehicle and its parts will not take damage from explosions.  Useful for vehicles like tanks that shouldn't be affected by this.")
