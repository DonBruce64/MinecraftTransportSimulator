...
public class JSONConfigSettings {
    ...
    public static class ConfigGeneral {
        ...
        //FIXME make sure this gets applied to higher MC versions.
        ...
        public JSONConfigEntry<Integer> airDensityDeclineRate = new JSONConfigEntry<>(6700, "Air density halves at every airDensityDeclineRate of altitude which will affects the aircraft's climb performance a lot. 6700 being a realistic value, 1 being the min value and must be whole number. Planes can usually climb to the height between 1*airDensityDeclineRate and 2*airDensityDeclineRate blocks.");
