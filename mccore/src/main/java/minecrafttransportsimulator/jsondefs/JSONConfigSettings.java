...
public class JSONConfigSettings {
    ...
    public static class ConfigGeneral {
        ...
        public JSONConfigEntry<Double> airDensityDeclineRate = new JSONConfigEntry<>(67000.D, "Determines the rate at which air density decreases with altitude. with 67,000 being a realistic value, will affects the aircraft's climb performance");
