...
public class JSONConfigSettings {
    ...
    public static class ConfigGeneral {
        ...
        public JSONConfigEntry<Double> airDensityDeclineRate = new JSONConfigEntry<>(6700.0D, "Air density halves at every airDensityDeclineRate of altitude. with 6700 being a realistic value, will affects the aircraft's climb performance a lot, the planes can usually climb to the height between 1*airDensityDeclineRate and 2*airDensityDeclineRate.");
