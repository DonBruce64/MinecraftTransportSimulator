...
public class JSONConfigSettings {
    ...
    public static class ConfigGeneral {
        ...
        public JSONConfigEntry<Double> seaLevel = new JSONConfigEntry<>(63.0D,"The Y-Level that will be used to base altitude off of. Will also be factored in for engine performance calculations. Change only if you know what you're doing/ why this matters to engines/flying.");
