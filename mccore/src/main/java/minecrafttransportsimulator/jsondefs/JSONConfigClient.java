...
public class JSONConfigClient {
    ...
    public static class JSONControlSettings {
        ...
        public JSONConfigEntry<Boolean> simpleThrottle = new JSONConfigEntry<>(true, "If true, ground vehicles use simplified driving controls: gas/brake also handle forward and reverse shifting when stopped, the vehicle auto-holds the brake at low speed, and transmissions shift automatically while driving. The parking brake is also applied when the last driver leaves a ground vehicle.");
        ...
        public JSONConfigEntry<Boolean> arcadeMode = new JSONConfigEntry<>(false, "If true, arcade-style flight and mouse aiming will be enabled. This allows the mouse cursor to control aircraft/helicopter steering systems.");
