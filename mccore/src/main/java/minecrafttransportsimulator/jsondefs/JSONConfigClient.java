...
public class JSONConfigClient {
    ...
    public static class JSONRenderingSettings {
        ...
        public JSONConfigEntry<Boolean> renderBeams = new JSONConfigEntry<>(true, "If false, flares on lights will not render.");
        public JSONConfigEntry<Boolean> renderFlares = new JSONConfigEntry<>(true, "If false, beams on lights will not render.");
