...
public class PackMaterialComponent {
    ...
    private static Map<String, String> generateFlattnedMappings(){
        ...
        map.put("minecraft:banner:8", "minecraft:banner:8");
        map.put("minecraft:banner:9", "minecraft:banner:9");
        map.put("minecraft:banner:10", "minecraft:banner:10");
        map.put("minecraft:banner:11", "minecraft:banner:11");
        map.put("minecraft:banner:12", "minecraft:banner:12");
        map.put("minecraft:banner:13", "minecraft:banner:13");
        map.put("minecraft:banner:14", "minecraft:banner:14");
        map.put("minecraft:banner:15", "minecraft:banner:15");
