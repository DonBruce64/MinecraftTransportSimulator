...
class WrapperNBT implements IWrapperNBT {
    ...
    public UUID getUUID(String name) {
        return tag.contains(name) ? UUID.fromString(tag.getString(name).orElse("")) : null;
    }
    ...
    public List<IWrapperItemStack> getStacks(int count) {
        ...
        ContainerHelper.loadAllItems(TagValueInput.create(ProblemReporter.DISCARDING, getRegistryAccess(), tag), mcList);
    ...
    public void setStacks(List<IWrapperItemStack> stacks) {
        ...
        ContainerHelper.saveAllItems(output, mcList);
    ...
    public WrapperNBT getData(String name) {
        return tag.contains(name) ? new WrapperNBT(tag.getCompoundOrEmpty(name)) : null;
    }
