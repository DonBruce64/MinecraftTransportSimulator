...
public class InterfaceJEI implements IModPlugin {
    ...
    public Identifier getPluginUid() {
        return Identifier.fromNamespaceAndPath(InterfaceLoader.MODID, "main");
    }
    ...
    private static class BenchRecipeCategory implements IRecipeCategory<PackRecipeWrapper> {
        ...
        private BenchRecipeCategory(ItemDecor benchItem, List<PackRecipeWrapper> benchRecipes, IGuiHelper guiHelper) {
            ...
            this.background = guiHelper.createDrawable(Identifier.fromNamespaceAndPath(InterfaceLoader.MODID, "textures/guis/jei_crafting.png"), 0, 0, 134, 97);
            this.icon = guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK, ((WrapperItemStack) benchItem.getNewStack(null)).stack);
        }

        @Override
        public IRecipeType<PackRecipeWrapper> getRecipeType() {
            return IRecipeType.create(Identifier.fromNamespaceAndPath(InterfaceLoader.MODID, benchItem.getRegistrationName()), PackRecipeWrapper.class);
        }
        ...
        public void setRecipe(IRecipeLayoutBuilder builder, PackRecipeWrapper recipe, IFocusGroup focuse) {
            ...
            if (components != null) {
                ...
                builder.addSlot(RecipeIngredientRole.OUTPUT, 59, 71).add(((WrapperItemStack) recipe.packItem.getNewStack(null)).stack);
            }
        }
    }
}
