...
public class JSONVehicle extends AJSONPartProvider {
    ...
    public static class VehicleMotorized {
        ...
        @JSONDescription("If set, this vehicle will be able to select and connect to beacons for directional way finding.")
        ...
        @JSONDescription("Set this to true if the vehicle has these lights. This will make the respective switch appear in the panel.")
        ...
        @JSONDescription("Enables pitch/roll/yawAngle. User made rotation physics is required in order to function properly, so it is disabled by default. If you need to make small tweaks to rotations without overriding the whole system, consider pitch/roll/yawForce")
        public boolean customTiltAngles;

        @ModifiableValue
        @JSONDescription("Manually sets the current roll (left/right tilt) of the vehicle. If the value is set to 1 and is unchanged, the vehicle will have it's rotation set to 1 degree and will be unchanged until the value is updated. Useful for custom physics")
        public float rollAngle;

        @ModifiableValue
        @JSONDescription("Manually sets the current pitch (up/down tilt) of the vehicle. If the value is set to 1 and is unchanged, the vehicle will have it's rotation set to 1 degree and will be unchanged until the value is updated. Useful for custom physics")
        public float pitchAngle;

        @ModifiableValue
        @JSONDescription("Manually sets the current yaw (the direction the vehicle is facing) of the vehicle. If the value is set to 1 and is unchanged, the vehicle will have it's rotation set to 1 degree and will be unchanged until the value is updated. useful for custom physics")
        public float yawAngle;

        @ModifiableValue
        @JSONDescription("Manually adjusts the current roll (left/right tilt), adding whatever the current value is per tick. If the value is set to 1 and is unchanged, the vehicle will spin 1 degree per tick. useful for minor physics tweaks, or custom physics.")
        public float rollForce;

        @ModifiableValue
        @JSONDescription("Manually adjusts the current pitch (up/down tilt), adding whatever the current value is per tick. If the value is set to 1 and is unchanged, the vehicle will spin 1 degree per tick. useful for minor physics tweaks, or custom physics.")
        public float pitchForce;

        @ModifiableValue
        @JSONDescription("Manually adjusts the current yaw (the direction the vehicle is facing), adding whatever the current value is per tick. If the value is set to 1 and is unchanged, the vehicle will spin 1 degree per tick. useful for minor physics tweaks, or custom physics.")
