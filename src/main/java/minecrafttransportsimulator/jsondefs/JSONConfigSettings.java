...
public class JSONConfigSettings{
	...
	public static class ConfigGeneral{
		...
		public JSONConfigEntry<Double> vehicleScale = new JSONConfigEntry<Double>(1.0D, "Scale of all vheicles in the mod.  You probably won't want to change this, but if you do want the vehicles to be smaller for some reason, you can.");
