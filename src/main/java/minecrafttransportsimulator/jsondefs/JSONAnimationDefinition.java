...
public class JSONAnimationDefinition {
    ...
    public enum AnimationEasingType {
        ...
        EASEINOUTSINE,
        @JSONDescription("Accelerating from zero velocity. Quadratic.")
        EASEINQUAD,
        @JSONDescription("Decelerating to zero velocity. Quadratic.")
        EASEOUTQUAD,
        @JSONDescription("Acceleration until halfway, then deceleration. Quadratic.")
        EASEINOUTQUAD,
