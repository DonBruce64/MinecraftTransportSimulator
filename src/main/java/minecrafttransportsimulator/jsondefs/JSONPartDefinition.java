...
public class JSONPartDefinition {
    ...
    @JSONDescription("The default yaw for the gun in this slot. If the gun has resetPosition to true, then it will move to this position if it's not active. This takes into account the gun's min/max yaw, and if this default exceeds those bounds, it will not be used.")
