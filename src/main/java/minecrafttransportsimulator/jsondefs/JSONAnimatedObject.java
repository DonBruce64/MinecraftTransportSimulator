...
public class JSONAnimatedObject {
    ...
    @JSONDescription("A listing of animation objects. This defines the animations to be applied to the object specified in objectName. If you have none, chances are you need to combine something in your model!")
