...
public class JSONInstrumentDefinition {
    ...
    @JSONDescription("Setting this to true will move this instrument to the panel rather than the main HUD. Useful in multi-engine vehicles where you don't want to clog the main HUD with a bunch of tachometers.")
