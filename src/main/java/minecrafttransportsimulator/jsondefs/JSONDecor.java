...
public class JSONDecor extends AJSONMultiModelProvider{
    ...
    public class JSONDecorGeneric{
		...
		@JSONDescription("The fuel capacity of the decor. Units are in milli-buckets. Only use if this decor is a fuel pump. If not set, a value of 15 is used.")
		public int fuelCapacity;
		
		@JSONDescription("The quantity of fuel to pump per tick. Units are in milli-buckets. Only use if this decor is a fuel pump. If not set, a value of 10 is used.")
