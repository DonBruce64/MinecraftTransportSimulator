...
public class JSONCraftingBench{
	...
	@JSONDescription("A optional list of part types this component can craft.  Only used to filter “part” itemTypes.  For example, adding “engine” would allow the component to craft all engines, but adding “engine_car” and “engine_boat” would prevent it from crafting aircraft engines.")
