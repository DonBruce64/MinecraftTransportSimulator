...
public abstract class AJSONInteractableEntity extends AJSONMultiModelProvider {
    ...
    @JSONDescription("A list of instruments definitions. Instrument definitions are used to tell MTS where to render instruments on the object, and where they correspond to on the HUD. They may also specify which part the instrument goes to.")
