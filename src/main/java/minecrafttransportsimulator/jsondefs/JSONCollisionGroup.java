...
public class JSONCollisionGroup {
    ...
    @JSONDescription("A optional listing of animations to use to modify the collision boxes. Translation/rotation animations do what you would expect. Visibility animations will completely disable the hitbox if they are false.")
