...
public class PartGroundDevice extends APart{
	...
	public double getRawVariableValue(String variable, float partialTicks){
		switch(variable){
			...
			case("ground_position"): return (EntityVehicleF_Physics.SPEED_FACTOR*(angularPosition + angularVelocity*partialTicks))-Math.floor(EntityVehicleF_Physics.SPEED_FACTOR*(angularPosition + angularVelocity*partialTicks));
