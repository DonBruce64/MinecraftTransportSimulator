 ...
 * until it returns true. Once it does, joysticks may be used. If it does not, it means joystick
...
public interface IInterfaceInput {
     ...
     * when opening a GUI that handles key presses, but it should be un-set upon closure
    ...
    /**
     * Returns true if joystick support is blocked. This happens if the joystick support
