...
public class BlockTrafficSignalController extends ABlockBase implements WrapperTileEntityTickable.IProvider{
	
	public BlockTrafficSignalController(WrapperBlock wrapperReference){
