	...
	public static enum PoleComponentType{
		...
		public static ATileEntityPole_Component createComponent(TileEntityPole pole, WrapperPlayer placingPlayer, Axis axis, WrapperNBT data){
			...
			switch(item.definition.pole.type){
				...
				case STREET_LIGHT : return new TileEntityPole_StreetLight(pole, placingPlayer, axis, data);
				case SIGN : return new TileEntityPole_Sign(pole, placingPlayer, axis, data);
			}
