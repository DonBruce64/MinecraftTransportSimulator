	...
	public void renderText(boolean renderTextLit){
		...
		if(enabled){
			if(focused && AGUIBase.inClockPeriod(20, 10)){
				RenderText.drawText(flashText, null, textPosition, null, fontColor, TextAlignment.LEFT_ALIGNED, 1.0F, false, width, 1.0F, renderTextLit);
			}else{
				RenderText.drawText(text, null, textPosition, null, fontColor, TextAlignment.LEFT_ALIGNED, 1.0F, false, width, 1.0F, renderTextLit);
			}
		}else{
			RenderText.drawText(text, null, textPosition, null, ColorRGB.GRAY, TextAlignment.LEFT_ALIGNED, 1.0F, false, width, 1.0F, renderTextLit);
		}
    }
