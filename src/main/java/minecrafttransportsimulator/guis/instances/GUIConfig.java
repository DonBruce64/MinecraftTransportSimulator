...
public class GUIConfig extends AGUIBase{
	...
	public void setupComponents(int guiLeft, int guiTop){
		...
		addLabel(vehicleSelectionFaultLabel = new GUIComponentLabel(guiLeft+10, guiTop+110, Color.BLACK, BuilderGUI.translate("gui.config.joystick.error"), 1.0F, false, false, 240));
