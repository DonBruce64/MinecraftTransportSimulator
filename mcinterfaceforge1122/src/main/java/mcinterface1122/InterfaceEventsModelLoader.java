...
public class InterfaceEventsModelLoader {
    ...
    private static class PackResourcePack implements IResourcePack {
        ...
        public boolean resourceExists(ResourceLocation location) {
            try {
                if (!location.getPath().contains("blockstates/") && !location.getPath().contains("armatures/") && !location.getPath().contains(".mcmeta") && !location.getPath().contains("advancements/") && !location.getPath().contains("recipes/") && !location.getPath().contains("lang/") && ((location.getPath().endsWith(".json") && !location.getPath().equals("sounds.json")) || location.getPath().endsWith(".png"))) {
                    enableDebug = false;
