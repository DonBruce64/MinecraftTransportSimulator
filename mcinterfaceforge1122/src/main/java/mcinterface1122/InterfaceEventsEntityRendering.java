...
public class InterfaceEventsEntityRendering {
     ...
     */
    @SubscribeEvent
    public static void preCameraSetup(CameraSetup event) {
     ...
     */
    @SubscribeEvent
    public static void preRenderLiving(@SuppressWarnings("rawtypes") RenderLivingEvent.Pre event) {
     ...
     */
    @SubscribeEvent
    public static void postRenderLiving(@SuppressWarnings("rawtypes") RenderLivingEvent.Post event) {
        if (needToPopMatrix) {
            GL11.glPopMatrix();
            EntityLivingBase entity = event.getEntity();
