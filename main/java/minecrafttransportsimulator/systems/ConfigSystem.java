...
public final class ConfigSystem{
	...
	public static void initCommon(File configFile){
		...
		stringConfigMap.put("ItemWeights", config.get(COMMON_CONFIG, "ItemWeights", "iron:90;gold:215;coal:72;stone:64;cobblestone:64;ore:10;diamond_block:10;iron_block:780;gold_block:1930;coal_block:640;diamond_ore:8;iron_ore:77;gold_ore:140;coal_ore:68", "Custom item weights written in pattern \"name:weight\" and separated by semicolon (;). Name is the word that item unlocalized name must contain to match, weight is weight defined in kilos. The earlier the pattern is written in string, the more priority it has").getString());
