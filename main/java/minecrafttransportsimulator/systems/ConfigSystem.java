...
public final class ConfigSystem{
	...
	public static void initCommon(File configFile){
		...
		stringConfigMap.put("ItemWeights", config.get(COMMON_CONFIG, "ItemWeights", "blockDiamond:10;blockIron:780;blockGold:1930;blockCoal:640;oreDiamond:8;oreIron:77;oreGold:140;oreCoal:68;iron:90;gold:215;coal:72;stone:64;cobblestone:64;ore:10;", "Custom item weights written in pattern \"name:weight\" and must be finished with a semicolon (;). Name is the word that item unlocalized name must contain to match, weight is weight defined in kilos. The earlier the pattern is written in string, the more priority it has").getString());
