...
public class GUIPackMissing extends MTSGui{
	...
	protected void handleDraw(int mouseX, int mouseY){
		...
		renderBackground();
		MTSRendererInterface.bindTexture(GUI_STANDARD_TEXTURE);
		renderTexturedQuad(guiTextureLeft, guiTextureTop, 0, 0, 256, 192, 256, 192);

		
		if(MTSMetronome.isOnHalf(40)){
			GL11.glPushMatrix();
			GL11.glTranslatef(guiTextureLeft + 90 - MTSRendererInterface.getTextWidth(I18n.format("gui.packmissing.title"))/2F, guiTextureTop + 10, 0);
			GL11.glScalef(3, 3, 3);
			MTSRendererInterface.drawText(I18n.format("gui.packmissing.title"), 0, 0, Color.RED, false, false);
			GL11.glPopMatrix();
		}
		...
		MTSRendererInterface.drawEssay(I18n.format("gui.packmissing.reason"), 0, 0, Color.BLACK, 320);
		...
		GL11.glScalef(0.75F, 0.75F, 0.75F);
		MTSRendererInterface.drawEssay(I18n.format("gui.packmissing.nomod"), 0, 0, Color.BLACK, 320);
		GL11.glPopMatrix();
		
		GL11.glPushMatrix();
		GL11.glTranslatef(guiTextureLeft + 10, guiTextureTop + 90, 0);
		GL11.glScalef(0.75F, 0.75F, 0.75F);
		MTSRendererInterface.drawEssay(I18n.format("gui.packmissing.modlink"), 0, 0, Color.BLACK, 320);
		GL11.glPopMatrix();
		
		GL11.glPushMatrix();
		GL11.glTranslatef(guiTextureLeft + 10, guiTextureTop + 115, 0);
		GL11.glScalef(0.75F, 0.75F, 0.75F);
		MTSRendererInterface.drawEssay(I18n.format("gui.packmissing.misplaced"), 0, 0, Color.BLACK, 320);
		GL11.glPopMatrix();
		
		GL11.glPushMatrix();
		GL11.glTranslatef(guiTextureLeft + 10, guiTextureTop + 150, 0);
		GL11.glScalef(0.75F, 0.75F, 0.75F);
		MTSRendererInterface.drawEssay(I18n.format("gui.packmissing.versionerror"), 0, 0, Color.BLACK, 320);
		GL11.glPopMatrix();
	}
