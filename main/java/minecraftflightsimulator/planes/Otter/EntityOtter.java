...
public class EntityOtter extends EntityPlane{
	...
	public void initParentContainerSlots(ContainerParent container){
		//TODO make new GUI
		container.addSlotToContainer(new SlotItem(this, 86, 113, 1, MFS.proxy.wheelLarge));
		container.addSlotToContainer(new SlotItem(this, 50, 113, 2, MFS.proxy.wheelLarge));
		container.addSlotToContainer(new SlotItem(this, 68, 113, 4, MFS.proxy.wheelLarge));
		
		container.addSlotToContainer(new SlotItem(this, 131, 66, 6, MFS.proxy.engineSmall));
		container.addSlotToContainer(new SlotItem(this, 131, 82, 7, MFS.proxy.engineSmall));
		
		container.addSlotToContainer(new SlotItem(this, 150, 66, 10, MFS.proxy.propeller));
		container.addSlotToContainer(new SlotItem(this, 150, 82, 11, MFS.proxy.propeller));
