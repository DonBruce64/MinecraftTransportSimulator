...
public class EntityTrimotor extends EntityPlane{
	...
	private static final ResourceLocation mouldingTexture = new ResourceLocation("mfs", "textures/planes/trimotor/side_rotated.png");
	...
	protected void initPartData(){
		...
		this.partData.add(new PartData(2.875F, -2.3F, 0.8F, EntityWheel.EntityWheelLarge.class));
		this.partData.add(new PartData(2.875F, -0.46F, 0.86F, false, false, 1, EntityEngineAircraft.class));
		this.partData.add(new PartData(0, -0.46F, 3.56F, false, false, 1, EntityEngineAircraft.class));
		this.partData.add(new PartData(-2.875F, -0.46F, 0.86F, false, false, 1, EntityEngineAircraft.class));
