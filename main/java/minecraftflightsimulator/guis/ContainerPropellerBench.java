...
public class ContainerPropellerBench extends Container{
	...
	public ContainerPropellerBench(InventoryPlayer invPlayer, TileEntityPropellerBench tile){
		this.tile = tile;
		this.addSlotToContainer(new SlotItem(tile, 0, 12, 54, Items.iron_ingot));
		this.addSlotToContainer(new SlotItem(tile, 1, 63, 54, Item.getItemFromBlock(Blocks.planks), Items.iron_ingot, Item.getItemFromBlock(Blocks.obsidian)));
		this.addSlotToContainer(new SlotItem(tile, 2, 12, 107, Items.redstone));
		this.addSlotToContainer(new SlotItem(tile, 3, 127, 54));
		SlotItem dummy = new SlotItem(tile, 4, 63, 36);
		dummy.enabled = false;
