...
public class GUIPropellerBench extends GuiContainer{
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY){
		...
		GL11DrawSystem.renderSquare(10, 26, 28, 12, 0, 0, false);
		GL11DrawSystem.bindTexture(ironPropellerIcon);
		GL11DrawSystem.renderSquare(40, 56, 28, 12, 0, 0, false);
		GL11DrawSystem.bindTexture(obsidianPropellerIcon);
		GL11DrawSystem.renderSquare(70, 86, 28, 12, 0, 0, false);
		GL11DrawSystem.bindTexture(ironIngotIcon);
		GL11DrawSystem.renderSquare(12, 28, 52, 36, 0, 0, false);
		GL11DrawSystem.bindTexture(redstoneIcon);
		GL11DrawSystem.renderSquare(12, 28, 106, 90, 0, 0, false);
		GL11DrawSystem.bindTexture(arrow);
		if(tile.timeLeft > 0){
			GL11DrawSystem.renderSquareUV(89, 113 - 24F*tile.timeLeft/tile.opTime, 70, 54, 0, 0, 0, 1 - 1F*tile.timeLeft/tile.opTime, 0, 1, false);
		}
		...
		GL11DrawSystem.renderSquare(159, 175, 70, 54, 0, 0, false);
    ...
    public void drawScreen(int mouseX, int mouseY, float renderPartialTicks){
		...
		GL11DrawSystem.drawString("Blades", guiLeft + 43, guiTop + 90, Color.BLACK);
		GL11DrawSystem.drawString("Diameter", guiLeft + 86, guiTop + 90, Color.BLACK);
		GL11DrawSystem.drawString("Pitch", guiLeft + 139, guiTop + 90, Color.BLACK);
		
		GL11DrawSystem.drawString(String.valueOf(propBlades), guiLeft + 205, guiTop + 10, Color.BLACK);
		GL11DrawSystem.drawString(String.valueOf(propDiameter), guiLeft + 196, guiTop + 38, Color.BLACK);
		GL11DrawSystem.drawString(String.valueOf(propPitch), guiLeft + 194, guiTop + 84, Color.BLACK);
	}
