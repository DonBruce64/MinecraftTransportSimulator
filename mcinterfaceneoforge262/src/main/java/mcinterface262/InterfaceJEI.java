...
public class InterfaceJEI implements IModPlugin {
    ...
    private static class BenchRecipeCategory implements IRecipeCategory<PackRecipeWrapper> {
        ...
        public IRecipeType<PackRecipeWrapper> getRecipeType() {
            return IRecipeType.create(InterfaceLoader.MODID, benchItem.getRegistrationName(), PackRecipeWrapper.class);
        }
        ...
        @Override
        public void createRecipeExtras(IRecipeExtrasBuilder builder, PackRecipeWrapper recipe, IFocusGroup focuses) {
