...
public class BuilderEntityExisting extends ABuilderEntityBase {
        ...
        if (entity != null) {
            ...
            if (!loadedFromSavedNBT && loadFromSavedNBT) {
                ...
                try {
                    ...
                    entity = entityMap.get(lastLoadedNBT.getStringOr("entityid", "")).restoreEntityFromData(worldWrapper, data);
                    ...
                    InterfaceManager.coreInterface.logError("Failed to load entity on builder from saved NBT.  Did a pack change?  Missing entity ID: " + lastLoadedNBT.getStringOr("entityid", "<none>"));
    ...
    public void saveWithoutId(ValueOutput output) {
        ...
        if (entity != null) {
            ...
            entity.save(new WrapperNBT(entityTag));
            entityTag.putString("entityid", entity.getClass().getSimpleName());
            output.store(MTS_DATA_KEY, CompoundTag.CODEC, entityTag);
        }
    }
