...
public class BuilderBlock extends Block {
    ...
    BuilderBlock(ABlockBase block, ResourceKey<Block> id) {
        super(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(block.hardness, block.blastResistance).noOcclusion().setId(id));
        this.block = block;
    }
