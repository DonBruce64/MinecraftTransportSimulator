...
public class WrapperPlayer extends WrapperEntity implements IWrapperPlayer {
    ...
    public boolean isOP() {
        ...
        return server == null || server.getPlayerList().getOps().get(player.nameAndId()) != null || server.isSingleplayer();
    }

    @Override
    public void displayChatMessage(LanguageEntry language, Object... args) {
        Minecraft.getInstance().gui.hud.getChat().addClientSystemMessage(Component.literal(String.format(language.getCurrentValue(), args)));
    }
