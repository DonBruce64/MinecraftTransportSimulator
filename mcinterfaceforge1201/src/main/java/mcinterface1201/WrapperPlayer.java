...
public class WrapperPlayer extends WrapperEntity implements IWrapperPlayer {
    ...
    public void openCraftingGUI() {
        player.openMenu(
                new SimpleMenuProvider(
                        (i, arg3, arg4) -> new CraftingMenu(i, arg3, ContainerLevelAccess.create(player.level(), player.blockPosition())) {
    ...
    public static void onIVWorldUnload(LevelEvent.Unload event) {
        playerWrappers.keySet().removeIf(entityPlayer -> entityPlayer.level().equals(event.getLevel()));
    }
}