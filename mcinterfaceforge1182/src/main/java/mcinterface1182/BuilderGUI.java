...
import net.minecraft.client.audio.SimpleSoundInstance;
import net.minecraft.client.gui.font.TextFieldHelper;
import net.minecraft.client.gui.fonts.TextFieldHelper;
            ...
            for (AGUIComponent component : gui.components) {
                if (component instanceof GUIComponentTextBox) {
                    ...
                    if (textBox.focused) {
                        ...
                        if (isPaste(keyCode)) {
                            textBox.setText(TextFieldHelper.getClipboardContents(minecraft));
                        } else {
                            char key = 0;
                            switch (keyCode) {
